...
<div class="container auth-container">
    ...
    @endif        
    <form method="post" action="{{url('sign-in-admin-seg-66')}}" class="form-control form">
        @csrf
        ...
        <tr>
            <td>New Admin? <a href="{{url('register-admin-seg-66')}}" class="btn btn-default">Sign-up</a></td>
        </tr>
        </table>
        </div>
    </form>
